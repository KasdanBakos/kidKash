namespace :db do
  ...
  task :populate => :environment do
    ...
    kaz_user = User.new
    kaz_user.role = "parent"
    kaz_user.password = "secret"
    kaz_user.password_confirmation = "secret"
    kaz_user.username = "kaz"
    kaz_user.email = "kaz@example.com"
    kaz_user.phone = "412-268-3259"
    kaz_user.active = true
    kaz_user.save! 
    kaz = Family.new
    kaz.parent_first_name = "Kaz"
    kaz.family_name = "Bakos"
    kaz.user_id = kaz_user.id
    kaz.active = true
    kaz.save!
